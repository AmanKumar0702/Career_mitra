...
const testimonials = [
  { name: "Priya Sharma",  role: "Class 12 Student, Delhi",      avatar: "PS", color: "from-cyan-400 to-cyan-600",    text: "CareerMitra helped me discover that I'm passionate about data science. The roadmap was so clear — I knew exactly what to study next!" },
  { name: "Rahul Verma",   role: "Engineering Fresher, Pune",     avatar: "RV", color: "from-indigo-400 to-indigo-600", text: "I got my first internship through CareerMitra's job portal. The skill-based filters made it easy to find roles that matched my profile." },
  ...
  { name: "Arjun Mehta",   role: "Class 10 Student, Jaipur",      avatar: "AM", color: "from-indigo-400 to-cyan-500",   text: "I scored 92% in my Class 10 boards after using CareerMitra's Science MCQ tests. The weak area detection is a game changer!" },
    ...
    <section id="testimonials" className="py-24 bg-white dark:bg-[#0a0f1e] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl font-extrabold text-gray-900 dark:text-white mb-4">Students Love CareerMitra</h2>
